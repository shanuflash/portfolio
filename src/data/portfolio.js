...
export const projects = [
  ...
  },
  {
    ...
    name: 'InvoicEzz',
    status: 'Live',
    description: 'Generate print-ready invoices that automatically sync stock — every sale deducts inventory in real time.',
  ...
  },
  {
    ...
    name: 'Whispr',
    status: 'Live',
    description: 'Drop-in chat rooms with typing indicators, presence, and iMessage-style grouping — zero backend, powered by Ably.',
