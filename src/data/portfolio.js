export const products = [
  ...
  // Text Tools
  {
    ...
    status: "Live",
    category: "Text Tools",
    description: "Counts words, characters (with and without spaces), sentences, and paragraphs",
    isExternal: true,
    gridPosition: "border-b md:border-b-0 md:border-r border-border border-gray-200"
  },
  {
  ...
  },
  {
    ...
    status: "Live",
    category: "Developer Tools",
    description: "Prettify and validate JSON data to make it readable and error-free",
    isExternal: true,
    gridPosition: "border-b md:border-b-0 border-border border-gray-200"
  },
  ...
  // Design Tools
  {
    ...
    description: "Convert between HEX, RGB, HSL, and CMYK color formats with color picker",
    isExternal: true,
    gridPosition: "border-b md:border-b-0 md:border-r border-border border-gray-200"
  },
  {
...
export const infoItems = [
  {
    id: "role",
    icon: 'Code',
    content: "Frontend Developer at SurveySparrow (2023 - Present)"
  },
  {
    id: "email",
    icon: 'Mail',
